...
import com.whitespace.mydailyvuadmin.Routine.Fragment_Monday;
...
public class AddClassMonday extends AppCompatActivity {
    ...
    private void loadData() {
        ...
        btnStartTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                timepickerdialog = new TimePickerDialog(AddClassMonday.this,
        ...
        String DAY = intent.getStringExtra(Fragment_Monday.EXTRA_DAY);
...
//                    userMap.put("user_id", userID);
                    ...
                    document_ref.set(userMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            startTime.setText("-- : -- --");
                            endTime.setText("-- : -- --");
                            Toast.makeText(AddClassMonday.this, "Class Added", Toast.LENGTH_LONG).show();
                        }
                    }).addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(AddClassMonday.this, e.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    });
                    finish();
