...
import com.whitespace.mydailyvuadmin.Routine.Fragment_Thursday;
...
public class AddClassThursday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        document_ref = db.collection("Routine").document();
    ...
    private void loadData() {
        ...
        spinnerSemester.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (semester.equals("10")) {
                    routine_subject10();
                }
                if (semester.equals("11")) {
                    routine_subject11();
                }
        ...
        btnStartTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                timepickerdialog = new TimePickerDialog(AddClassThursday.this,
        ...
        String DAY = intent.getStringExtra(Fragment_Thursday.EXTRA_DAY);
...
//                    userMap.put("user_id", userID);
                    ...
                    document_ref.set(userMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            startTime.setText("-- : -- --");
                            endTime.setText("-- : -- --");
                            Toast.makeText(AddClassThursday.this, "Class Added", Toast.LENGTH_LONG).show();
                        }
                    }).addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(AddClassThursday.this, e.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    });
                    finish();
    ...
    private void routine_subject1() {
        spinnerRoutine = findViewById(R.id.spinnerRoutine);
        final ArrayAdapter<CharSequence> routineAdapter = ArrayAdapter.createFromResource(this,
                R.array.routine1, android.R.layout.simple_spinner_item);
        ...
        final ArrayAdapter<CharSequence> subjectAdapter = ArrayAdapter.createFromResource(this,
                R.array.subject1, android.R.layout.simple_spinner_item);
    ...
    private void routine_subject2() {
        spinnerRoutine = findViewById(R.id.spinnerRoutine);
        final ArrayAdapter<CharSequence> routineAdapter = ArrayAdapter.createFromResource(this,
                R.array.routine2, android.R.layout.simple_spinner_item);
        routineAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerRoutine.setAdapter(routineAdapter);
        spinnerRoutine.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
        ...
        spinnerSubject = findViewById(R.id.spinnerSubject);
        final ArrayAdapter<CharSequence> subjectAdapter = ArrayAdapter.createFromResource(this,
                R.array.subject2, android.R.layout.simple_spinner_item);
        subjectAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerSubject.setAdapter(subjectAdapter);
        spinnerSubject.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
    ...
    private void routine_subject3() {
        spinnerRoutine = findViewById(R.id.spinnerRoutine);
        final ArrayAdapter<CharSequence> routineAdapter = ArrayAdapter.createFromResource(this,
                R.array.routine3, android.R.layout.simple_spinner_item);
        routineAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerRoutine.setAdapter(routineAdapter);
        spinnerRoutine.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
        ...
        spinnerSubject = findViewById(R.id.spinnerSubject);
        final ArrayAdapter<CharSequence> subjectAdapter = ArrayAdapter.createFromResource(this,
                R.array.subject3, android.R.layout.simple_spinner_item);
        subjectAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerSubject.setAdapter(subjectAdapter);
        spinnerSubject.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
    ...
    private void routine_subject4() {
        spinnerRoutine = findViewById(R.id.spinnerRoutine);
        final ArrayAdapter<CharSequence> routineAdapter = ArrayAdapter.createFromResource(this,
                R.array.routine4, android.R.layout.simple_spinner_item);
        routineAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerRoutine.setAdapter(routineAdapter);
        spinnerRoutine.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
        ...
        spinnerSubject = findViewById(R.id.spinnerSubject);
        final ArrayAdapter<CharSequence> subjectAdapter = ArrayAdapter.createFromResource(this,
                R.array.subject4, android.R.layout.simple_spinner_item);
        subjectAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerSubject.setAdapter(subjectAdapter);
        spinnerSubject.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
    ...
    private void routine_subject5() {
        spinnerRoutine = findViewById(R.id.spinnerRoutine);
        final ArrayAdapter<CharSequence> routineAdapter = ArrayAdapter.createFromResource(this,
                R.array.routine5, android.R.layout.simple_spinner_item);
        routineAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerRoutine.setAdapter(routineAdapter);
        spinnerRoutine.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
        ...
        spinnerSubject = findViewById(R.id.spinnerSubject);
        final ArrayAdapter<CharSequence> subjectAdapter = ArrayAdapter.createFromResource(this,
                R.array.subject5, android.R.layout.simple_spinner_item);
        subjectAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerSubject.setAdapter(subjectAdapter);
        spinnerSubject.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
    ...
    private void routine_subject6() {
        spinnerRoutine = findViewById(R.id.spinnerRoutine);
        final ArrayAdapter<CharSequence> routineAdapter = ArrayAdapter.createFromResource(this,
                R.array.routine6, android.R.layout.simple_spinner_item);
        routineAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerRoutine.setAdapter(routineAdapter);
        spinnerRoutine.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
        ...
        spinnerSubject = findViewById(R.id.spinnerSubject);
        final ArrayAdapter<CharSequence> subjectAdapter = ArrayAdapter.createFromResource(this,
                R.array.subject6, android.R.layout.simple_spinner_item);
        subjectAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerSubject.setAdapter(subjectAdapter);
        spinnerSubject.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
    ...
    private void routine_subject7() {
        spinnerRoutine = findViewById(R.id.spinnerRoutine);
        final ArrayAdapter<CharSequence> routineAdapter = ArrayAdapter.createFromResource(this,
                R.array.routine7, android.R.layout.simple_spinner_item);
        routineAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerRoutine.setAdapter(routineAdapter);
        spinnerRoutine.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
        ...
        spinnerSubject = findViewById(R.id.spinnerSubject);
        final ArrayAdapter<CharSequence> subjectAdapter = ArrayAdapter.createFromResource(this,
                R.array.subject7, android.R.layout.simple_spinner_item);
        subjectAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerSubject.setAdapter(subjectAdapter);
        spinnerSubject.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
    ...
    private void routine_subject8() {
        spinnerRoutine = findViewById(R.id.spinnerRoutine);
        final ArrayAdapter<CharSequence> routineAdapter = ArrayAdapter.createFromResource(this,
                R.array.routine8, android.R.layout.simple_spinner_item);
        routineAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerRoutine.setAdapter(routineAdapter);
        spinnerRoutine.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
        ...
        spinnerSubject = findViewById(R.id.spinnerSubject);
        final ArrayAdapter<CharSequence> subjectAdapter = ArrayAdapter.createFromResource(this,
                R.array.subject8, android.R.layout.simple_spinner_item);
        subjectAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerSubject.setAdapter(subjectAdapter);
        spinnerSubject.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
    ...
    private void routine_subject9() {
        spinnerRoutine = findViewById(R.id.spinnerRoutine);
        final ArrayAdapter<CharSequence> routineAdapter = ArrayAdapter.createFromResource(this,
                R.array.routine9, android.R.layout.simple_spinner_item);
        routineAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerRoutine.setAdapter(routineAdapter);
        spinnerRoutine.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
        ...
        spinnerSubject = findViewById(R.id.spinnerSubject);
        final ArrayAdapter<CharSequence> subjectAdapter = ArrayAdapter.createFromResource(this,
                R.array.subject9, android.R.layout.simple_spinner_item);
        subjectAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerSubject.setAdapter(subjectAdapter);
        spinnerSubject.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
    ...
    private void routine_subject10() {
        spinnerRoutine = findViewById(R.id.spinnerRoutine);
        final ArrayAdapter<CharSequence> routineAdapter = ArrayAdapter.createFromResource(this,
                R.array.routine10, android.R.layout.simple_spinner_item);
        routineAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerRoutine.setAdapter(routineAdapter);
        spinnerRoutine.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
        ...
        spinnerSubject = findViewById(R.id.spinnerSubject);
        final ArrayAdapter<CharSequence> subjectAdapter = ArrayAdapter.createFromResource(this,
                R.array.subject10, android.R.layout.simple_spinner_item);
        subjectAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerSubject.setAdapter(subjectAdapter);
        spinnerSubject.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
    ...
    private void routine_subject11() {
        spinnerRoutine = findViewById(R.id.spinnerRoutine);
        final ArrayAdapter<CharSequence> routineAdapter = ArrayAdapter.createFromResource(this,
                R.array.routine11, android.R.layout.simple_spinner_item);
        routineAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerRoutine.setAdapter(routineAdapter);
        spinnerRoutine.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
        ...
        spinnerSubject = findViewById(R.id.spinnerSubject);
        final ArrayAdapter<CharSequence> subjectAdapter = ArrayAdapter.createFromResource(this,
                R.array.subject11, android.R.layout.simple_spinner_item);
        subjectAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerSubject.setAdapter(subjectAdapter);
        spinnerSubject.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
    ...
    private void routine_subject12() {
        spinnerRoutine = findViewById(R.id.spinnerRoutine);
        final ArrayAdapter<CharSequence> routineAdapter = ArrayAdapter.createFromResource(this,
                R.array.routine12, android.R.layout.simple_spinner_item);
        routineAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerRoutine.setAdapter(routineAdapter);
        spinnerRoutine.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
        ...
        spinnerSubject = findViewById(R.id.spinnerSubject);
        final ArrayAdapter<CharSequence> subjectAdapter = ArrayAdapter.createFromResource(this,
                R.array.subject12, android.R.layout.simple_spinner_item);
        subjectAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerSubject.setAdapter(subjectAdapter);
        spinnerSubject.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
