...
public class CRAdapter extends FirestoreRecyclerAdapter<Profile, CRAdapter.CRHolder> {

    private OnItemClickListener listener;
    private Context mContext;

    public CRAdapter(@NonNull FirestoreRecyclerOptions<Profile> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull CRHolder holder, int position, @NonNull Profile model) {
